...
import com.example.kommunicatechat.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    boolean exit = false;
    public static final String APP_ID = "YOUR API";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    final String userIdText = binding.userIdEditText.getText().toString().trim();
                    String passwordText = binding.passwordEditText.getText().toString().trim();
                    if (TextUtils.isEmpty(userIdText) || binding.userIdEditText.getText().toString().trim().length() == 0) {
                    ...
                    progressDialog.show();
                    initLoginData(binding.userIdEditText.getText().toString().trim(), binding.passwordEditText.getText().toString().trim(), progressDialog);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        binding.btnLoginAsVisitor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isPlaceHolderAppId()) {
                    return;
    ...
    public void showSnackBar(int resId) {
        Snackbar.make(binding.footerSnack, resId,
